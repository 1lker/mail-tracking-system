...
# outlook bozuyor mail yapısını

# SMTP Configuration with dotenv
...
mailing_list = ["bakkal.ahmet@outlook.com"]
...
def create_html_content(tracking_id):
    ...
    <head>
      ...
      <style>
        ...
        .header {{
          background-image: url('cid:header_bg');
    ...
    <body">
      ...
      <div class="container">
      <div class="">
        <img src="cid:header_bg" alt="Header Background" style="width: -webkit-fill-available;height: 60px;">
        </div>
        <div class="header">
          <img src="cid:logo" alt="Bosch Logo" class="logo">
        </div>
        <div class="content">
          ...
          <p style="text-align: center;">
            <a href="{tracked_button_link}" class="cta-button" style="color:white">Check Application Status</a>
          </p>
...
def send_email(recipient):
    ...
    # Attach logo
    with open('image2.png', 'rb') as logo_file:
        logo_image = MIMEImage(logo_file.read())
        logo_image.add_header('Content-ID', '<logo>')
        msg.attach(logo_image)

    # Attach header background
    with open('image1.png', 'rb') as bg_file:
        bg_image = MIMEImage(bg_file.read())
        bg_image.add_header('Content-ID', '<header_bg>')
        msg.attach(bg_image)
